...
Image_4:setPosition(786.0000, 0.0000)
...
layout:setTopMargin(434.7500)
layout:setBottomMargin(165.2500)
Scene:addChild(game)
...
about:setPosition(619.0000, 185.2500)
...
exit:setPosition(885.0000, 185.2500)
