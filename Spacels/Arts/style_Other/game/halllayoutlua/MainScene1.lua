...
Image_2:loadTexture("game/Spacels/image/Maininterface/BG1.png",0)
...
Image_3:loadTexture("game/Spacels/image/Maininterface/BG1.png",0)
...
game:setPosition(394.5000, 460.7500)
...
layout:setTopMargin(159.2500)
layout:setBottomMargin(440.7500)
Scene:addChild(game)
...
about:setPosition(394.5000, 313.7500)
...
layout:setLeftMargin(334.5000)
layout:setRightMargin(505.5000)
layout:setTopMargin(306.2500)
layout:setBottomMargin(293.7500)
...
exit:setPosition(394.5000, 159.7500)
...
layout:setLeftMargin(334.5000)
layout:setRightMargin(505.5000)
layout:setTopMargin(460.2500)
layout:setBottomMargin(139.7500)
Scene:addChild(exit)
