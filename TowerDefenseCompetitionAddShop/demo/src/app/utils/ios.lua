...
function iosBuy(productid,price,playerid,itemName)
	...
	local args = { arg1 = tostring(productid), arg2 = price, arg3 = tostring(playerid)}
...
function callLuaFunc(itemStr)
    print("itemStr = "..itemStr);
    if ShejianGameScene then
        ShejianGameScene.addGoldCoin(self,itemStr);
    else
        print("nil nil nil nil nil nil nil nil ");
   end
end

_G["callLuaFunc"] = callLuaFunc
cc.exports.callLuaFunc = callLuaFunc
