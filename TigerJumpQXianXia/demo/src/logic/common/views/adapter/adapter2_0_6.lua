...
tolua.iskindof = tolua.iskindof or function() 
    return false
end
...
local _setTextColor = ccui.Text.setTextColor
ccui.Text.setTextColor = function(self, t, ...)
    if (t.a) then
        _setTextColor(self, t, ...)
    else
        t.a = 255
        _setTextColor(self, t, ...)
    end
...
local _setBlendFunc = cc.Sprite.setBlendFunc
cc.Sprite.setBlendFunc = function(self, t, ... )
    if(t.src) then
        _setBlendFunc(self, t.src, t.dst)
    else
        _setBlendFunc(self, t, ... )
    end
end
