...
role:setPosition(360.0000, 100.0000)
...
basemodel:setPosition(360.0000, 970.5001)
basemodel:setScaleX(0.6000)
basemodel:setScaleY(0.6000)
if callBackProvider~=nil then
      basemodel:addClickEventListener(callBackProvider("main.lua", basemodel, "onBaseModel"))
end
...
layout:setTopMargin(235.9999)
layout:setBottomMargin(897.0001)
...
upmodel:setPosition(360.0000, 816.0248)
upmodel:setScaleX(0.6000)
upmodel:setScaleY(0.6000)
if callBackProvider~=nil then
      upmodel:addClickEventListener(callBackProvider("main.lua", upmodel, "onUpModel"))
end
layout = ccui.LayoutComponent:bindLayoutComponent(upmodel)
layout:setPositionPercentX(0.5000)
layout:setPositionPercentY(0.6375)
layout:setPercentWidth(0.5736)
layout:setPercentHeight(0.1148)
layout:setSize({width = 413.0000, height = 147.0000})
layout:setLeftMargin(153.5000)
layout:setRightMargin(153.5000)
layout:setTopMargin(390.4752)
layout:setBottomMargin(742.5248)
