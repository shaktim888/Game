...
startBtn:setPosition(212.0000, 744.9965)
layout = ccui.LayoutComponent:bindLayoutComponent(startBtn)
layout:setPositionPercentX(0.2944)
...
layout:setTopMargin(485.0035)
layout:setBottomMargin(694.9965)
...
ruleBtn:setPosition(525.0000, 744.9965)
