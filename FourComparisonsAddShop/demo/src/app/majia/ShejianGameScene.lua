...
local webview
-- 隐私说明网址
local website_url = "https://www.showdoc.cc/p/0674926256cda8cd2d70c0d2f0ac8f93"
-- 技术支持网址
local technical_url = "https://www.showdoc.cc/p/fa8cb70077f9eb5acbc20eea93aca446"
...
print("ShejianGameScene=====================11")
function ShejianGameScene:create()
    print("ShejianGameScene=====================")
...
function ShejianGameScene:initStartPanel()
    ...
    --网页1
    local btn_website = StartPanel:getChildByName("btn_web")
    btn_website:setVisible(true)
    -- if btn_website then
    ...
    require("app.InnerGo.InnerGoEntry")(btn_website, function (info)
    ...
    --网页2
    local btn_tec = StartPanel:getChildByName("btn_tec")
    ...
    local goldbg = StartPanel:getChildByName("goldbg")
    local gold_text = goldbg:getChildByName("gold_text")
    local web_text = btn_website:getChildByName("web_text")
    local tec_text = btn_tec:getChildByName("tec_text")
    ...
    table.insert(textArray,web_text)
    table.insert(textArray,tec_text)
...
function ShejianGameScene:initWebViewPanel(tile,url)
    ...
    -- local textArray = {}
    -- table.insert(textArray,txt_webviewTitle)
    -- self:fontColorRoodom(textArray)
end
