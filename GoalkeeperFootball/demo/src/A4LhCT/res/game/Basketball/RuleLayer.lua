...
bg:loadTexture("game/Basketball/image/popbg.png",0)
...
Text_1:setFontName("game/Basketball/image/a.ttf")
Text_1:setFontSize(30)
Text_1:setString([[Slide the screen to control the strength and angle of the football shot, let the football pass the goalkeeper's block, go to where it should be, and try it out!]])
