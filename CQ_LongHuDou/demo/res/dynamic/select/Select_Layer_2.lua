...
btnJob1:setPosition(193.0223, 463.3669)
...
layout:setLeftMargin(74.8713)
layout:setRightMargin(975.1287)
layout:setTopMargin(213.4907)
layout:setBottomMargin(399.5093)
...
btnJob2:setPosition(184.9236, 316.8969)
layout = ccui.LayoutComponent:bindLayoutComponent(btnJob2)
layout:setPositionPercentX(0.1445)
layout:setPositionPercentY(0.4401)
layout:setPercentWidth(0.1797)
layout:setPercentHeight(0.1486)
layout:setSize({width = 230.0000, height = 107.0000})
layout:setLeftMargin(73.4656)
layout:setRightMargin(976.5344)
layout:setTopMargin(341.0431)
layout:setBottomMargin(271.9569)
...
btnJob3:setPosition(197.8345, 204.3261)
...
layout:setPercentHeight(0.1486)
layout:setSize({width = 230.0000, height = 107.0000})
layout:setLeftMargin(74.8765)
layout:setRightMargin(975.1235)
layout:setTopMargin(468.5939)
layout:setBottomMargin(144.4061)
...
btnSex2:setPosition(1122.5840, 413.6210)
...
layout:setLeftMargin(1073.7720)
layout:setRightMargin(122.2284)
layout:setTopMargin(263.5663)
layout:setBottomMargin(369.4337)
...
btnSex1:setPosition(1111.2940, 252.7632)
...
layout:setLeftMargin(1073.7720)
layout:setRightMargin(122.2284)
layout:setTopMargin(422.6928)
layout:setBottomMargin(210.3072)
...
Image_9:setPosition(10.2070, 640.7987)
...
layout:setLeftMargin(10.2070)
layout:setRightMargin(880.7930)
