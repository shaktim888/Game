...
role:setAnchorPoint(0.0000, 0.5000)
role:setPosition(-1.0000, 358.3803)
...
layout:setTopMargin(1.6197)
layout:setBottomMargin(-1.6197)
Layer:addChild(role)
...
btn_start:setPosition(1031.0000, 290.9999)
...
layout:setSize({width = 260.0000, height = 192.0000})
layout:setLeftMargin(901.0000)
layout:setRightMargin(119.0000)
layout:setTopMargin(333.0001)
layout:setBottomMargin(194.9999)
...
tips:setAnchorPoint(0.5000, 1.0000)
tips:setPosition(640.0000, 720.0000)
...
panel_top_btn:setPosition(0.0000, 679.0000)
