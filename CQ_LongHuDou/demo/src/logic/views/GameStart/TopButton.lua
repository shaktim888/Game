...
TopButton.TopBtn = {
    ...
    btn_notice =      {callBack = "onBtnRuleClick",    normal_picpath = "common/btn_icon/btn_notice.png"},
...
function TopButton:ctor(parent,data)
    self.panel_top_btn = nil
    if parent.mView then
        self.panel_top_btn = parent.mView["panel_top_btn"]
    end
    if not self.panel_top_btn then
        local visibleSize = cc.Director:getInstance():getVisibleSize()
