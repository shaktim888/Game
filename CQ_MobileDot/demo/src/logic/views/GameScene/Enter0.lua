...
function ShejianGameScene:init()
    ...
    -- img_start_gold = StartPanel:getChildByName("img_gold");
    -- local role = StartPanel:getChildByName("role");
    -- role:setPositionY(-150)
    -- role:ignoreContentAdaptWithSize(true)
    -- txt_gold = img_start_gold:getChildByName("txt_gold");
    -- local gold_number = cc.UserDefault:getInstance():getIntegerForKey("gold",1);
    -- txt_gold:setString(""..gold_number);
    -- btn_gamepanel_sound = GamePanel:getChildByName("btn_sound");
    -- btn_sound = StartPanel:getChildByName("btn_sound");
    ...
    --     self:onSound();
    -- end);
    -- btn_gamepanel_sound:onClick(function (...)
    --     self:onSound();
    -- end);

    -- self:initHelpPanelEX()
    -- self:initStartPanel()
    self:initGamePanel()
    -- self:initScorePanel()
