...
function ShejianGameScene:init()
	...
	gameLevelText = GamePanel:getChildByName("SetPanel"):getChildByName("level"):getChildByName("Text")    
	gameScoreText = GamePanel:getChildByName("SetPanel"):getChildByName("score"):getChildByName("Text")  
	scoreText = GamePanel:getChildByName("scoreText")
	gameTimeText = GamePanel:getChildByName("SetPanel"):getChildByName("time"):getChildByName("Text")  
	gameGoalText = GamePanel:getChildByName("SetPanel"):getChildByName("goal"):getChildByName("Text")  
	...
	local headPanel = GamePanel:getChildByName("headPanel")
	...
	play:loadTexture("select/job/huoban_".._aSaveInfo.job.."_".._aSaveInfo.sex..".png")
