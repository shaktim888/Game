...
global.viewController = require("logic.viewController.viewController")
global.viewData = require("logic.viewsData.GameData")
...
require("logic.common.views.adapter.adapter2_0_6")
