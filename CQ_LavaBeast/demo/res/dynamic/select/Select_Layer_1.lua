...
dec:setPosition(1028.0000, 343.0000)
...
btnJob1:setPosition(190.6774, 347.6954)
...
layout:setLeftMargin(72.5264)
layout:setRightMargin(977.4736)
layout:setTopMargin(329.1622)
layout:setBottomMargin(283.8378)
...
btnJob2:setPosition(182.5798, 201.2268)
layout = ccui.LayoutComponent:bindLayoutComponent(btnJob2)
layout:setPositionPercentX(0.1426)
layout:setPositionPercentY(0.2795)
layout:setPercentWidth(0.1797)
layout:setPercentHeight(0.1486)
layout:setSize({width = 230.0000, height = 107.0000})
layout:setLeftMargin(71.1218)
layout:setRightMargin(978.8782)
layout:setTopMargin(456.7132)
layout:setBottomMargin(156.2868)
...
btnJob3:setPosition(195.4899, 88.6571)
...
layout:setPercentHeight(0.1486)
layout:setSize({width = 230.0000, height = 107.0000})
layout:setLeftMargin(72.5319)
layout:setRightMargin(977.4681)
layout:setTopMargin(584.2629)
layout:setBottomMargin(28.7371)
...
btnSex2:setPosition(151.4613, 484.0276)
layout = ccui.LayoutComponent:bindLayoutComponent(btnSex2)
layout:setPositionPercentX(0.1183)
layout:setPositionPercentY(0.6723)
layout:setPercentWidth(0.0656)
layout:setPercentHeight(0.1208)
layout:setSize({width = 84.0000, height = 87.0000})
layout:setLeftMargin(102.0357)
layout:setRightMargin(1093.9640)
layout:setTopMargin(191.5676)
layout:setBottomMargin(441.4324)
...
btnSex1:setPosition(260.9088, 483.8916)
...
layout:setPercentHeight(0.1208)
layout:setSize({width = 84.0000, height = 87.0000})
layout:setLeftMargin(223.3860)
layout:setRightMargin(972.6140)
layout:setTopMargin(191.5644)
layout:setBottomMargin(441.4356)
...
title:setPosition(11.6180, 640.7987)
