...
LoginScene.RESOURCE_FILENAME = "game/MountaintopJumps/LoginScene.lua"
print("你进入了登录界面")
local gameScene = require("logic.game.MountaintopJumps.gameScene")
local ruleScene = require("logic.game.MountaintopJumps.ruleLayer")
