...
Game.behavior ={
    ...
    "logic.game.LongHuDou.logic.uiControl",
    "logic.game.LongHuDou.logic.stateControl",
    "logic.game.LongHuDou.logic.player",
    "logic.game.LongHuDou.logic.AI"
}
...
function Game:onCreate(level,select)
    self._iLevel = level
    
    local localSave = global.saveTools.getData(cfg.LocalSave)
    localSave.curlevel = self._iLevel
    localSave.select = select
    ...
    self.s_aLevelsDiagram = require("logic.game.LongHuDou.cfg.levelCfg")
