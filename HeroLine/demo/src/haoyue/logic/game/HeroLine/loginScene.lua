...
LoginScene.RESOURCE_FILENAME = "game/HeroLine/LoginScene.lua"
print("你进入了登录界面")
local gameScene = require("logic.game.HeroLine.gameScene")
local ruleScene = require("logic.game.HeroLine.ruleLayer")
