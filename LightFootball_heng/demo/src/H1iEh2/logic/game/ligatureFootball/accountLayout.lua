...
function AccountLayer:onCreate(status,level)
    self.mView["btn_menu"]:addClickEventListener(handler(self,self.onMenuClick))
    self.mView["btn_restart"]:addClickEventListener(handler(self,self.onRestartClick))
    self.mView["btn_next"]:addClickEventListener(handler(self,self.onNextClick))
    self.mView["btn_again"]:addClickEventListener(handler(self,self.onAgainClick))
