...
function Game:onCreate(_data)
    ...
    self.mView["btnAttack"]:setVisible(false)
    ...
    local addComponentConfig = {
        ...
        self.mView["text_score"]
    }
    local panel_top_btn = require("logic/viewController/componentController").new(addComponentConfig,self.data.btnInfo)
    self:initGameRole()
