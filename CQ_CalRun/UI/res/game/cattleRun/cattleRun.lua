...
text_score:setFontName("game/cattleRun/image/nvpk.ttf")
text_score:setFontSize(35)
text_score:setString([[000]])
...
text_score:setPosition(129.0588, 235.5000)
text_score:setTextColor({r = 234, g = 181, b = 56})
layout = ccui.LayoutComponent:bindLayoutComponent(text_score)
layout:setPositionPercentX(0.1008)
layout:setPositionPercentY(0.3271)
layout:setPercentWidth(0.0477)
layout:setPercentHeight(0.0611)
layout:setSize({width = 61.0000, height = 44.0000})
layout:setLeftMargin(129.0588)
layout:setRightMargin(1089.9410)
layout:setTopMargin(456.7624)
layout:setBottomMargin(219.2376)
