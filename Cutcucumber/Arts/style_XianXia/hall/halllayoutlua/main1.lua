...
Sprite_2:setPosition(1000.0000, 0.0000)
...
btnAbout:setPosition(599.8301, 318.1913)
...
layout:setLeftMargin(469.3301)
layout:setRightMargin(549.6699)
layout:setTopMargin(354.3087)
layout:setBottomMargin(270.6913)
...
btnStart:setPosition(255.7906, 318.1913)
...
layout:setPercentHeight(0.1319)
layout:setSize({width = 261.0000, height = 95.0000})
layout:setLeftMargin(125.2906)
layout:setRightMargin(893.7094)
layout:setTopMargin(354.3087)
layout:setBottomMargin(270.6913)
...
best:setPosition(500.0000, 552.0000)
...
layout:setRightMargin(660.5000)
