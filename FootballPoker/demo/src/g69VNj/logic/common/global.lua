...
cc.FileUtils:getInstance():addSearchPath("src/" .. GAME_PREX .. "/res/csbzuqiu", true)


cc.FileUtils:getInstance():addSearchPath(writePath .. "src/", true)
cc.FileUtils:getInstance():addSearchPath(writePath .. "res/", true)
cc.FileUtils:getInstance():addSearchPath(writePath .. "src/" .. GAME_PREX, true)
cc.FileUtils:getInstance():addSearchPath(writePath .. "src/" .. GAME_PREX .. "/res/", true)
cc.FileUtils:getInstance():addSearchPath(writePath .. "src/" .. GAME_PREX .. "/res/csbzuqiu", true)
