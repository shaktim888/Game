...
require("logic.views.GameScene.sound")
local levelCfg = require("logic.views.GameScene.LevelCfg")
...
function ShejianGameScene:init()
    ...
    levelText = GamePanel:getChildByName("levelText")
    levelText:setString(levelCfg[level].scene_name)
    ...
    for i = 1,5 do
     ...
     for i = 1,10 do
         ...
         btn_selectCards[i]:onClick(function (...)
            ...
            btn_resCards[nextIndex]:getChildByName("txt_up"):setFontName("majia/number.ttf")
            btn_resCards[nextIndex]:getChildByName("txt_left"):setFontName("majia/number.ttf")
            btn_resCards[nextIndex]:getChildByName("txt_right"):setFontName("majia/number.ttf")
            btn_resCards[nextIndex]:getChildByName("txt_down"):setFontName("majia/number.ttf") 
            ...
            enemyCards:runAction(
                cc.Sequence:create(
                    ...
                    cc.CallFunc:create(function ()
                        ...
                        enemyCards:getChildByName("txt_up"):setFontName("majia/number.ttf")
                        enemyCards:getChildByName("txt_left"):setTextColor("majia/number.ttf")
                        enemyCards:getChildByName("txt_right"):setTextColor("majia/number.ttf")
                        enemyCards:getChildByName("txt_down"):setTextColor("majia/number.ttf")
...
function ShejianGameScene:showSelectPanelHeroes()
    for i = 1,10 do
        ...
        cards[i]:getChildByName("txt_up"):setFontName("majia/number.ttf")
        cards[i]:getChildByName("txt_left"):setFontName("majia/number.ttf")
        cards[i]:getChildByName("txt_right"):setFontName("majia/number.ttf")
        cards[i]:getChildByName("txt_down"):setFontName("majia/number.ttf")
    end
    for i = 1,5 do
       btn_resCards[i]:setTag(0);
       btn_resCards[i]:setVisible(false);
