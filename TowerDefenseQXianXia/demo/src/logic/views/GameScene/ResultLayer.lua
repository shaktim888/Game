local GameResultLayer = class("GameResultLayer", cc.load("mvc").ModuleBase)
GameResultLayer.RESOURCE_FILENAME = "game/Game_Result.lua"

function GameResultLayer:onCreate(_data)
...
function GameResultLayer:gotoStart()
